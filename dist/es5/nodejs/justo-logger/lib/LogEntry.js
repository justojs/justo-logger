...
function LogEntry(source, level, timestamp, message) {_classCallCheck(this, LogEntry);
  ...
  Object.defineProperty(this, "message", { value: message, enumerable: true });};exports.default = LogEntry;
